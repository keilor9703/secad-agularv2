...
namespace Negocio.Interfaz
{
    public interface IDbMenuService
    {
        ...
        Task<DtoMenuResult> ReemplazarMenusDeRolAsync(int idRol, IReadOnlyCollection<long> idMenus, bool puedeGestionarSuper, long usuarioAuditoria, string maquinaAuditoria, CancellationToken ct);
    }
}
